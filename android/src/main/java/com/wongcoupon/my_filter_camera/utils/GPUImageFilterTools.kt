...
object GPUImageFilterTools {
    fun createFilterList(context: Context): ArrayList<GPUImageFilter> {
        val filterList = ArrayList<GPUImageFilter>()
        val filterDefault = GPUImageFilter(
            GPUImageFilter.NO_FILTER_VERTEX_SHADER,
            GPUImageFilter.NO_FILTER_FRAGMENT_SHADER
        )
        val bulgeZoomOut = createFilterForType(context, FilterType.BULGE_DISTORTION)
        val filterAdjuster = FilterAdjuster(bulgeZoomOut)
        filterAdjuster.adjust(75)
        val bulgeZoomIn = createFilterForType(context, FilterType.BULGE_DISTORTION)
        val filterAdjuster2 = FilterAdjuster(bulgeZoomIn)
        filterAdjuster2.adjust(25)
        val filterVignette = createFilterForType(context, FilterType.VIGNETTE)
        val filterAdjuster3 = FilterAdjuster(filterVignette)
        filterAdjuster3.adjust(0)
        val filterMonochrome = createFilterForType(context, FilterType.MONOCHROME)
        val filterAdjuster4 = FilterAdjuster(filterMonochrome)
        filterAdjuster4.adjust(100)
        val filterSepia = createFilterForType(context, FilterType.SEPIA)
        val filterAdjuster5 = FilterAdjuster(filterSepia)
        filterAdjuster5.adjust(100)
        val filterSwirl = createFilterForType(context, FilterType.SWIRL)
        val filterAdjuster6 = FilterAdjuster(filterSwirl)
        filterAdjuster6.adjust(20)

        //--------------------------------------------------------------------
        filterList.add(createFilterForType(context, FilterType.GRAYSCALE))
        filterList.add(filterMonochrome)
        filterList.add(filterSepia)
        filterList.add(createFilterForType(context, FilterType.SKETCH))
        filterList.add(createFilterForType(context, FilterType.SMOOTH_TOON))
        filterList.add(filterVignette)
        filterList.add(bulgeZoomOut)
        filterList.add(bulgeZoomIn)
        filterList.add(filterSwirl)
        filterList.add(filterDefault) //index 9
        filterList.add(createFilterForType(context, FilterType.GRAYSCALE))
        filterList.add(filterMonochrome)
        filterList.add(filterSepia)
        filterList.add(createFilterForType(context, FilterType.SKETCH))
        ...
        filterList.add(bulgeZoomIn)
        filterList.add(filterSwirl)
        filterList.add(filterDefault)
        filterList.add(createFilterForType(context, FilterType.GRAYSCALE))
        filterList.add(createFilterForType(context, FilterType.MONOCHROME))
        filterList.add(createFilterForType(context, FilterType.SEPIA))
        filterList.add(createFilterForType(context, FilterType.SKETCH))
        filterList.add(createFilterForType(context, FilterType.SMOOTH_TOON))
        return filterList
    }

    fun createFilter(context: Context, index: Int): GPUImageFilter {
        return when (index) {
            0, 10 -> {
                createFilterForType(context, FilterType.GRAYSCALE)
            }
            ...
            2, 12 -> {
                val filterSepia = createFilterForType(context, FilterType.SEPIA)
                val filterAdjuster5 = FilterAdjuster(filterSepia)
                filterAdjuster5.adjust(50)
                filterSepia
            }

            3, 13 -> {
                createFilterForType(context, FilterType.SKETCH)
            }

            4, 14 -> {
                createFilterForType(context, FilterType.SMOOTH_TOON)
            }
            ...
            26 -> {
                createFilterForType(context, FilterType.ZOOM_BLUR)
            }
            27 -> {
                createFilterForType(context, FilterType.LUMINANCE)
            }
            28 -> {
                createFilterForType(context, FilterType.BLEND_ALPHA)
            }
            29 -> {
                createFilterForType(context, FilterType.HUE)
            }
            30 -> {
                createFilterForType(context, FilterType.PIXELATION)
            }
